...
original=imread('filter_off_laser_on_light_off.tif');
background=imread('filter_off_laser_off_light_off.tif');


% cut out some wird part of the images
for i=(412:449)
    for j=(109:134)
    original(i,j,1)= original(i,j+200,1);
    original(i,j,2)= original(i,j+200,2);   
    original(i,j,3)= original(i,j+200,3);   
...
for i = 1:10000  % the i is how many simulated pictures you want
    ...
    for j=1:Wsub+1
        for k=1:Hsub+1
            ...
            simulated_pic_noise(k,j)=noise(rand,part_of_1,part_of_2,part_of_3,part_of_4,part_of_5,part_of_6,part_of_7,part_of_8,part_of_9,part_of_10);
...
temperary_name2=load('C:\Users\Bruger\Documents\Uni\Image analysis\Projekt\data_fra_simuleringer\filter_no_light_no_laser_on-off_10000\middel_of_mass_simulated_images.mat', 'middel_of_mass_simulated_images');
...
% ylabel('Counter') 
% title('Variation in x') 
% saveas(figure(14),'Variation in x.png')
% 
% 
% figure(15)
...
% xlabel('relatively error between simulation and chosen y0') 
% title('Variation in y') 
% saveas(figure(15),'Variation in y.png')
% 
% 
% 
% 
...
% saveas(figure(16),'Histogram for picture with background noise simulated as Poission.png')
% 
% 
