...
for i = 1:N
    errors((i-1)*3+8) = (r11*xl(i)+r12*yl(i)+r13*f+r14*f/zl(i) - (xr(i)*zr(i)/zl(i)))^2;
    errors((i-1)*3+9) = (r21*xl(i)+r22*yl(i)+r23*f+r24*f/zl(i) - (yr(i)*zr(i)/zl(i)))^2;
    errors((i-1)*3+10) = (r31*xl(i)+r32*yl(i)+r33*f+r34*f/zl(i) - (f*zr(i)/zl(i)))^2;
end
