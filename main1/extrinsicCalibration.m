...
lb = [1-0.5   -0.5     -0.5     -260    -0.5     1-0.5     -0.5     -50    -0.5     -0.5     1-0.5     -100    -1400  -1400   -1400   -1000   -1400   -1400   -1400   -1400   -1000   -1400];
ub = [1+0.5   0.5      0.5      -240    0.5      1+0.5     0.5      50     0.5      0.5      1+0.5     100     -1250    -1250    -1250    -800    -1250   -1250    -1250    -1250    -800    -1250];
...
%options = optimoptions(@lsqnolin,'OptimalityTolerance',10^-10,'StepTolerance',10^-12,'FunctionTolerance',10^-10,'MaxFunctionEvaluations',50000,'MaxIterations',10000);
%x = lsqnolin(@(x)objective(x,laser_points,camera_points,f,baseLineLength),x0',lb',ub',options);
