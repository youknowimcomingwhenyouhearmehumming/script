...
original=imread('high_res_filter_on_laser_on.tif');
...
for i=(403:1048)
    for j=(1298:1345)
    background_blue_green(i,j)= background_blue_green(i,j-200);   
    end
end
...
for i = 1:10000  % the i is how many simulated pictures you want
    ...
    for j=1:Wsub+1
        for k=1:Hsub+1
            ...
            simulated_laser_dot_gauss(k,j)=fitresult.a1*exp(-(j-fitresult.x0).^2/(2*fitresult.sigmax^2)-(k-fitresult.x0).^2/(2*fitresult.sigmay^2));
