...
image3 = imread('img_dec14_85.2601.tif');
image4 = imread('img_dec14_74.2601.tif');
image5 = imread('img_dec14_94.2601.tif');
image6 = imread('img_dec14_71.2601.tif');
...
image6 = undistortImage(image6,cameraParams);
image7 = undistortImage(image7,cameraParams);
image8 = undistortImage(image8,cameraParams);
...
x0 = [1     0       0       -baseLineLength    0       1       0       0       0       0       1       0       -1250    -1250    -1250    -1250   -1250    -1250    -1250    -1250    -1250    -1250];
...
for i = 0:N_images-1
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%Get images
    try
        img_name = ['hånd/img_dec14_' num2str(Theta) '.tif'];
    ...
    for j = 1:19
        Phi = phi_between_dots*j-phi_between_dots*10;        
